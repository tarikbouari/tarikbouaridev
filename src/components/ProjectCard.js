...
const ProjectCard = ({ project, index = 0 }) => {
  ...
  return (
    ...
    <div ref={ref} className="md:grid grid-cols-2  py-8 ">
        ...
        <div className="flex flex-col tool and platform md:flex-row mt-6 gap-4 w-full">
          <div className="tool md:w-[70%] xl:w-[60%]">
            ...
            <div className="icon flex flex-wrap gap-4 mt-2 cursor-pointer">
              {Object.values(project.tools).map((tool) => (
                <p
                  key={Object.length}
                  className="hover:text-[#52eeca] bg-[#575F6F] px-2 rounded"
                >
                  {tool}
                </p>
              ))}
          ...
          <div className="platform xl:w-[40%] md:ml-6">
            ...
            <div className="flex gap-4 mt-2 cursor-pointer ">
              <Link
                to={project.links.git}
                target="_blank"
                className="hover:text-[#52eeca]"
              >
                <svg
      ...
      <div className="bg-[#112240] w-fll p-8 flex items-center group ">
        <img
          src={project.image}
          alt={project.titre}
          className="w-100 h-[auto] hover:scale-110 duration-300  inset-0  "
        />
      </div>
    </div>
  );
